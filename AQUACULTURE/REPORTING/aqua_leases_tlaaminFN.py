    ...
    sql['dig'] = """
        ...
        FROM WHSE_TANTALIS.TA_DISPOSITION_TRANSACTIONS DT 
          ...
          JOIN WHSE_ADMIN_BOUNDARIES.PIP_CONSULTATION_AREAS_SP FN
            ON SDO_RELATE(FN.SHAPE, SH.SHAPE, 'mask=ANYINTERACT')= 'TRUE'
                AND FN.CNSLTN_AREA_NAME = q'[Tla'amin Nation]'
...
def main():
    ...
    print ('Export report')
    create_report ([df_dig,df_exp], ['DIG', 'EXPIRED'],'aquaTenures_lease_Tla’amin_asof20230502')
